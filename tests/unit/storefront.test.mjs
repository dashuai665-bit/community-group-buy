...
test('TWD preserves fractional minor units without rounding away cash amounts', () => {
  for (const [minor, expected] of [[0,'NT$0'],[1,'NT$0.01'],[100,'NT$1'],[120,'NT$1.20'],[840,'NT$8.40'],[19900,'NT$199'],[19901,'NT$199.01']]) {
